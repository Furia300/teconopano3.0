...
export type DocHeaderNeuIconButtonProps = {
  children: ReactNode;
  ariaLabel: string;
  /** Faixa escura do header — repouso igual sidebar escura; hover vermelho como no claro. */
  dark?: boolean;
} & Omit<ButtonHTMLAttributes<HTMLButtonElement>, "type" | "aria-label" | "children">;

/**
 * Botão de ícone 36×36 — azulejos alinhados à sidebar (neu claro/escuro + hover vermelho + shimmer translúcido).
 */
