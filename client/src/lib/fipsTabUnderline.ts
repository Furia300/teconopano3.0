...
export const fipsUnderlineTabBar =
  "flex w-full flex-nowrap items-stretch overflow-x-auto border-b border-[#D7E0EA] bg-[#EDF2F8] dark:border-white/[0.1] dark:bg-[#2c2c2c] [scrollbar-width:thin] [&::-webkit-scrollbar]:h-1 [&::-webkit-scrollbar-thumb]:rounded-full [&::-webkit-scrollbar-thumb]:bg-[var(--fips-border-strong)]/35 dark:[&::-webkit-scrollbar-thumb]:bg-white/12";
